...
namespace alpsoftservistakip
{
    public partial class Page6 : Page
    {
        ...
        private void PageDisServisTablosunuYenile()
        {
            // Window3'ü bul ve PageDisServis'i yenile
            Window3 mainWindow = Application.Current.Windows.OfType<Window3>().FirstOrDefault();
            if (mainWindow != null)
            {
                // PageDisServis'i yenile
                var pageDisServis = mainWindow.OverlayFrame.Content as PageDisServis;
                if (pageDisServis != null)
                {
                    pageDisServis.ViewModel?.VerileriGetir();
                }
            }
        }
