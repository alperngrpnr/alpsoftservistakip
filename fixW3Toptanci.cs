...
class Program
{
    static void Main()
    {
        ...
        string btn = @"</Button>
                ...
                <Button x:Name=""btnToptanciYonetimi"" Content=""TOPTANCI YÖNETİMİ"" FontSize=""22"" Foreground=""White"" Background=""#FF252B36"" Width=""310"" Height=""82"" Click=""btnToptanciYonetimi_Click"" FontFamily=""Arial Black"" Cursor=""Hand"">
        ...
        if (t.Contains(search) && !t.Contains("btnToptanciYonetimi"))
        {
